...
import khabar2 from '../../img/8569056905-12.png';
            ...
            <div className=''>
              ...
              <div className='my-4 py-3 px-3' style={{ textAlign: 'justify', lineHeight: '30px' }}>
                <div className='border-bottom my-3 py-3'>
                  <span className='mx-4'>تاریخ : 1401/09/20 </span>
                </div>
                <p className='py-2 mx-3'>رئیس مرکز آموزش فنی و حرفه ای زعفرانیه از بهزیستی خیریه عمل ،به مناسبت ۱۲ آذر ماه روز جهانی بازدید و روند خدمت رسانی به این عزیزان را بررسی نمود و با اهدا گل به مددجویان این مرکز تقدیر بعمل آورد. </p>
              </div>
            </div>
          </div>
