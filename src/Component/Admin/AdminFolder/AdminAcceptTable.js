        ...
        <LayoutAdmin>
            <div className='container-fluid py-2 px-3 m-0 my-2 mb-4'>
                ...
                <div className='d-flex border-top m-2 p-3'>
                    <Link to="/AdminOkTable" className='fw-bold bg-opacity-75 bg-success btn m-1'> تایید درخواست </Link>
                    <Link to="/AdminCancel" className='fw-bold bg-opacity-75 bg-danger btn m-1'> رد درخواست </Link>
                    <Link to="/AdminOk" className='fw-bold bg-opacity-75 bg-info btn me-auto my-0'> بازگشت </Link>
                </div>
            </div>
        </LayoutAdmin>
    )
