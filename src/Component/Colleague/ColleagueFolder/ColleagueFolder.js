                ...
                <div className='border border-2 p-3 mt-2'>
                    <div className='col-6 col-md-6 col-lg-5 border border-2'>
                        <div className='m-0 w-100'>
                            ...
                            <Link to="/ColleagueAccept" className='bg-success btn rounded-0 d-flex justify-content-center text-white text-bold text-center p-2 text-decoration-none'>
                                پذیرش درخواست
                            </Link>
                        </div>
                    </div>
...
export default ColleagueFolder