        ...
        <LayoutColleague>
            <div className='container-fluid p-5 m-0 my-2 mb-4'>
                ...
                <div className='mt-5 pt-5 d-flex'>
                    <Link to="/ColleagueAcceptTable" className='btn bg-primary bgprimary border-0 text-white fw-bold col-auto me-auto '> مرحله بعدی </Link>
                </div>
            </div>
        </LayoutColleague>
    )
