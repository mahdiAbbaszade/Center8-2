        ...
        <LayoutColleague>
            <div className='container-fluid py-2 px-3 m-0 my-2 mb-4'>
                ...
                <div className='d-flex border-top m-2 p-3'>
                    <Link to="/ColleagueOkTable2" className='fw-bold bg-opacity-75 bg-success btn m-1'> تایید درخواست </Link>
...
export default ColleagueAcceptTable2