                ...
                <div className='border border-2 p-3 mt-2'>
                    <div className='col-4 border border-2'>
                        <div className='m-0 w-100'>
                            ...
                            <Link to="/ManageLayoutManageAccept2" className='bg-success btn rounded-0 d-flex justify-content-center text-white text-bold text-center p-2 text-decoration-none'>
                                ادامه امور
                            </Link>
                        </div>
                    </div>
