        ...
        <LayoutManage>
            <div className='container-fluid py-2 px-3 m-0 my-2 mb-4'>
                ...
                <div className='d-flex border-top m-2 p-3'>
                    <Link to="/ManageOk2" className='fw-bold bg-opacity-75 bg-success btn m-1'> تایید درخواست </Link>
                    <Link to="/ManageCancel2" className='fw-bold bg-opacity-75 bg-danger btn m-1'> رد درخواست </Link>
                    <Link to="#" className='fw-bold bg-opacity-75 bg-primary btn m-1'>ارجاع به </Link>
